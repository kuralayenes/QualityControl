...
namespace QualityControl.ViewModels
{
    ...
    public class InformationEntryViewModel : LoginViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="InformationEntryViewModel" /> class
        /// </summary>
        public InformationEntryViewModel()
        {
